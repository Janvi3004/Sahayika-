  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="mt-12 pt-6 border-t border-gray-200">
              <div className="flex justify-between items-center text-sm text-gray-600">
                <div>
                  ...
                  <p>Application ID: {Date.now()}</p>
                </div>
                <div className="text-right">
                  <p>Generated by Sahayika</p>
                  <p>Voice Form Assistant</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        <h3 className="font-medium text-green-800 mb-2">✅ Form Completed Successfully!</h3>
        <p className="text-green-700 text-sm">
          Your form has been filled out and is ready for submission. You can download it as a PDF or print it directly.
        </p>
      </div>
    </div>
  );
